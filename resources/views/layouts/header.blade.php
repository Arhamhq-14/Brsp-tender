<div class="main-header">
    ...
    <div class="logo-header" data-background-color="white">
        ...
        <a href="index.html" class="logo">
            <img src="{{asset('assets/img/brsp(2).png')}}" alt="navbar brand" class="navbar-brand">
        </a>
        <button class="navbar-toggler sidenav-toggler ml-auto" class="btn btn-primary" type="button" data-toggle="collapse" data-target="collapse" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <ul class="dropdown-menu dropdown-user animated fadeIn">
                        <div class="dropdown-user-scroll scrollbar-outer">
                            ...
                            <li>
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{route('custom-logout')}}">Logout</a>
                            </li>
                        </div>
                    </ul>
                </li>
